...
function MasterBrain(){
    ...
    return(
        ...
        <div>
            ...
            <p className='w-[70%] text-center m-auto pb-10'>Lorem ipsum dolor sit amet consectetur adipisicing elit. Nisi pariatur repellendus consequatur, veniam laudantium laboriosam libero cupiditate a expedita ut praesentium voluptate? Sit sequi nesciunt adipisci sunt repellat consectetur vero.</p>
        </div>
        <div className='grid-cols-3 gap-5 px-20 md:grid'>
            <div className="card">
                <div>
